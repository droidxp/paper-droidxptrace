...
%We also evaluated an extension to the \mas that we designed to improve the overall accuracy of the approach for malware detection. Although this extension reduces the number of false negatives of the \emph{vanilla \mas}, it was not sufficient to increase the \mas accuracy in the large dataset. 

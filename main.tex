...
\newcommand{\rqa}{What is the influence of the malware family and type on the performance of the \mas for malware detection?}

\newcommand{\rqb}{What is the influence of the similarity between the benign and malicious
                  versions of the apps on the performance of the \mas for malware detection}

\newcommand{\rqc}{How much gain we obtain on the performance of the \mas for malware detection when considering traces?}

\newcommand{\apps}{1203\xspace}

\newcommand{\sds}{Small Dataset\xspace}
\newcommand{\cds}{Complete Dataset\xspace}
\newcommand{\avt}{\texttt{avlass2} tool\xspace}
\newcommand{\vt}{VirusTotal\xspace}

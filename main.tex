...
\newcommand{\rqa}{Does the accuracy of Mining Android Sandbox approaches scale for large datasets?}
\newcommand{\rqb}{Do the proposed extensions (dynamic call graph analysis) improve the accuracy of the Mining Android Sandbox approach for suspicious app detection?}

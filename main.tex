...
\newcommand{\sscore}{Simi. Score\xspace}
...
\newcommand{\apps}{\textcolor{blue}{3,937}\xspace}
\newcommand{\napps}{\textcolor{blue}{726}\xspace}

\newcommand{\sds}{\texttt{DS1}\xspace}
\newcommand{\cds}{\texttt{DS2}\xspace}
\newcommand{\nds}{\texttt{DS3}\xspace}
...
\newcommand{\fscore}{\textcolor{blue}{0.60}\xspace}
\newcommand{\fscoreC}{\textcolor{blue}{0.49}\xspace}

\newcommand{\malwares}{\textcolor{blue}{2,719}\xspace}
\newcommand{\malwaresP}{\textcolor{blue}{69.06}}
\newcommand{\malwaresN}{\textcolor{blue}{87.98}}
\newcommand{\appsGps}{\textcolor{blue}{1,330}\xspace}
\newcommand{\appsGpsFN}{\textcolor{blue}{1,018}\xspace}
...
\author{Francisco Costa, %~\IEEEmembership{Member,~IEEE,}
        ...
        Mira Mezini,
        M\'{a}rcio Ribeiro, 
        and~Eduardo Alchieri% <-this % stops a space
\IEEEcompsocitemizethanks{
\IEEEcompsocthanksitem F. Costa, I. Medeiros, L. Oliveira, J. Cal\'{a}ssio, R. Bonif\'{a}cio, and E. Alchieri are with the 
Computer Science Department, University of Bras\'{i}lia, Bras\'{i}lia, Brazil.
E-mail: \{francisco.costa,ismael.medeiros,leandro.oliveira,joao.calassion\}@aluno.unb.br and \{rbonifacio,alchieri\}@unb.br.

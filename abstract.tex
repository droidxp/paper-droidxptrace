...
from the literature to enhance the \mas. However, these extensions only marginally improved the approach's performance, with both extensions combined increasing accuracy by 6\%
(from 59\% to 65\%)—--still falling short of the accuracy reported in previous studies.

...
\todo[inline]{Handrick, we are not citing here the main research contributions in the area. I mean, is there any particular reason for citing the works in this section, instead of for instance FlowDroid? FlowDroid is by far one of the most relevant static analysis tools for analysing Android apps. Lets discuss how to rewrite this section here. I would suggest Handrick read this survey, and then summarize this discussion highlighting the most relevant research works. \url{https://dl.acm.org/doi/pdf/10.1145/3017427}}
...
\todo[inline]{We should also explain how the mining sandbox approach can be used to identify malwares. Please,
take a look at our JSS paper and rewrite this part of the text here.}

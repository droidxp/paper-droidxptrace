...
\item \textbf{Efficiency gain with \mas extension (RQ4).}
\textcolor{blue}{Our investigation indicates that  
although the techniques presented demonstrate an accuracy gain, they still do not represent a big step towards to make \mas effective enough. That is, there is still a gap at \mas for malware detection, 
which requires further of alternative techniques investigation.}

...
\centering{
  \begin{tabular}{lrrrrrr} \hline
    ...
    \cds (4,076)    & 1,423  & 610 & 1,306 & 0.69       & 0.52   & 0.59  \\
...
labels a total of \review{$2,033$} repackaged apps as malware (\review{$49.41$\%} of the total number of repackaged
...
\tb{2}{
  ...
  dropping the \fone from $89\%$ to $0.59\%$ in comparison to
...
not reject our null hypothesis ($p$-value $=$ 0.89)(\review{Most review this number}). This finding suggests
...
achieves the highest percentage of correct classification (75.13\%) for the second
cluster (cId = 2), which
presents an average \sscore of 0.55\%. Nonetheless, the
cluster cId = 10, with larger number of samples (1414) and \sscore (0.99\%), presents
...
1 &   0.09 &  99 &  62 & 62.63 \\ 
  2 &    0.55 & 189 & 142 & 75.13 \\ 
  3 &    0.67 & 285 & 104 & 36.49 \\ 
  4 &    0.79 & 453 & 127 & 28.04 \\ 
  5 &    0.87 & 150 & 48 & 32.00 \\ 
  6 &    0.90 & 252 & 157 & 62.30 \\ 
  7 &    0.94 & 173 &  66 & 38.15 \\ 
  8 &    0.96 & 137 &  100 & 72.99 \\ 
  9 &    0.98 & 187 & 115 & 61.50 \\ 
  10 &   0.99 & 1414 & 502 & 35.60 \\ \hline
...
family and that for \appsGpsFN samples \review{($76.66$\%)}, the \mas was not able to correctly identify
...
of the \mas increases to \review{0.72} (\review{still small when compared with the original studies}). 
...
\multirow{2}{*}{Actual Condition}   & \multicolumn{2}{c}{Predicted Condition} \\ 
  ...
  Benign  (0)                       & TN (0)    & FP (0)    \\
  Malware (\appsGps)                     & FN (\appsGpsFN)  & TP (312)   \\ \hline
\end{tabular}
\label{tab:gappusin}
\end{table}
...
\tb{4}{The \mas fails to correctly
  identify \review{$76.66$\%} of the samples from the \gps family

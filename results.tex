...
\ses identify a malicious behavior in the asset (again, this
decision is in accordance to existing recommendations~\cite{vt-label,DBLP:journals/ese/KhanmohammadiEH19}).
...
labels a total of 204 repackaged apps as malware (16.73\% of the total number of repackaged
...
\sds (see the second row of Table~\ref{tab:accuracy}), $F_1$ dropping from 0.89 to 0.26.
...
\tb{2}{
  ...
  \cds (\cds pairs of apps),
  dropping the accuracy by a factor of 70.78\%  in comparison to
...
0.63 (median of 0.72 and sd of 0.32).
...
achieves the highest percentage of correct classification (63.27\%) for the third
cluster (cId = 3), which
presents an average \sscore of 0.67.
...
\begin{table}[ht]
 ...
 cId & \sscore & Samples & Correct Classification & Percentage \\ \midrule  
   1 & 0.11    & 260     & 153                    & 58.85 \\ 
   2 & 0.43    & 188     &  88                    & 46.81 \\ 
   3 & 0.67    & 196     & 124                    & 63.27 \\ 
   4 & 0.82    & 169     &  79                    & 46.75 \\ 
   5 & 0.96    & 406     & 137                    & 33.74 \\  \bottomrule
 \end{tabular}
 \end{scriptsize}

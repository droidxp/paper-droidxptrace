...
labels a total of \review{$2,014$} repackaged apps as malware (\review{$51.15$\%} of the total number of repackaged
...
\tb{2}{
  ...
  dropping the accuracy by a factor of \review{$32.58$\%} in comparison to
...
a percentage of correct classifications around 35.60\% (\review{Most review this cluster}). 
...
account for \review{$67.67$\%} of the repackaged apps in our \cds labeled as malware according to \vt.
...
family and that for \review{1,018} samples \review{($76.54$\%)}, the \mas was not able to correctly identify
...
of the \mas increases to \review{0.80} (\review{still small when compared with the original studies}). 
...
\tb{4}{The \mas fails to correctly
  identify \review{$76.54$\%} of the samples from the \gps family

...
\centering{
  \begin{tabular}{lrrrrrr} \hline
    ...
    \cds (3,937)    & 1,422  & 592 & 1,297 & 0.70       & 0.52   & 0.60  \\
...
labels a total of \textcolor{blue}{$2,014$} repackaged apps as malware (\textcolor{blue}{$51.15$\%} of the total number of repackaged
...
\tb{2}{
  ...
  dropping the accuracy by a factor of \textcolor{blue}{$32.58$\%} in comparison to
...
\textcolor{blue}{0.90} (median of \textcolor{blue}{0.98} and sd of \textcolor{blue}{0.18}).
...
not reject our null hypothesis ($p$-value $=$ 0.89)(\textcolor{blue}{Most review this number}). This finding suggests
...
a percentage of correct classifications around 35.60\% (\textcolor{blue}{Most review this cluster}). 
...
\textcolor{blue}{116 malware families}, though the most frequent
ones are \gps (1330 samples), \fm{revmob} (207 samples), \fm{dowgin} (183 samples) and \emph{airpush} (120 samples). Together, they
account for \textcolor{blue}{$67.67$\%} of the repackaged apps in our
...
family and that for \textcolor{blue}{1,018} samples \textcolor{blue}{($76.54$\%)}, the \mas was not able to correctly identify
...
of the \mas increases to \textcolor{blue}{0.80} (similar
...
\tb{4}{The \mas fails to correctly
  identify \textcolor{blue}{$76.54$\%} of the samples from the \gps family

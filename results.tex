...
\subsection{Complementary Techniques}\label{sec:resultsTraceParameter}
\textcolor{blue}{Here we will present the results of parameter and trace, and show table\ref{tab:accuracyParameter} as well}

\begin{table*}[htb]
  \caption{Accuracy of the \mas with the aid of complementary techniques.}
\centering{
  \begin{tabular}{lrrrrrr} \hline
    Dataset & TP   & FP  & FN  & Precision & Recall & $F_1$ \\ \hline
    
    %\mas + Traces  & \sds (102)   & 67   & 18  & 2   & 0.78      & 0.97   & 0.87  \\
    \cds \mas (3,211)    & 545  & 252 & 1,450 & 0.68       & 0.27   & 0.39  \\
    \cds \mas + Parameter (3,211)    & 656  & 271 & 1,339 & 0.7       & 0.32   & 0.44  \\
    \cds \mas + Trace + Parameter (3,211)    & 752  & 272 & 1,243 & 0.73       & 0.37   & 0.49  \\
    %\mas + Traces  & \cds (1203)   & 214  & 326 & 245 & 0.39      & 0.46   & 0.42  \\ 
    \hline
  \end{tabular}
  }

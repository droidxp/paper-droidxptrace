...
In most of the cases, the repackaged version just change the apk package or main
activity. Moreover, 29 out of the 30 samples in this dataset  {\bf modifies} thew 
...
class \texttt{com.game.a}. These class extensively use 
the Android reflection API, and we believe that removing the methods from this class is

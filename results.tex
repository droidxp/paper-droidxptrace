...
\tb{4}{The \mas fails to correctly
  identify $87.50$\% of the samples from the \gps family and $44.44\%$ of the samples from the \fm{revmob} as a malware. Just like \sscore, the presence of some malware families with high false negative rate, also influence the low recall of the \mas in the \cds.}
}
\review{

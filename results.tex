...
using DroidBot as a test case generator tool. The vanilla \mas also present seven app as malware, which was not confirmed by \vt, revealing a False Positive (FP colums).
...
only those particular samples in the \cds. Note that for 171 samples (86.36\%), the vanilla
\mas was able to correctly identify

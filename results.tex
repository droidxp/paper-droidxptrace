...
\centering{
  \begin{tabular}{lrrrrrr} \toprule
    ...
    \cds (1,707)    & 149  & 249 & 341 & 0.37       & 0.3   & 0.33  \\
...
large and more representative dataset.
...
0.59 (median of 0.68 and sd of 0.33).
...
achieves the highest percentage of correct classification (79.10\%) for the sixth
cluster (cId = 6), which
presents an average \sscore of 65\%.
...
\begin{table}[ht]
 ...
 \begin{tabular}{rrrrr}   \toprule
   cId & \sscore & Samples & Correct Classification & Percentage \\ \midrule
    1 & 0.03 & 185 & 134 & 72.43 \\ 
    2 & 0.12 & 143 & 104 & 72.73 \\ 
    3 & 0.25 & 146 &  94 & 64.38 \\
    4 & 0.41 & 120 &  88 & 73.33 \\ 
    5 & 0.53 & 126 &  92 & 73.02 \\ 
    6 & 0.65 & 177 & 140 & 79.10 \\ 
    7 & 0.74 & 125 & 103 & 82.40 \\ 
    8 & 0.82 & 158 & 113 & 71.52 \\ 
    9 & 0.90 & 156 &  88 & 56.41 \\ 
   10 & 0.97 & 371 & 161 & 43.40 \\  \bottomrule
 \end{tabular}
 \end{scriptsize}
...
ones are \gps (295 samples), \emph{revmob} (31 samples), \emph{dowgin} (25 samples) and \emph{airpush} (21 samples). Together, they
account for 21.79\% of the repackaged apps in our
...
only those particular samples in the \cds. Note that for 269 samples (91.18\%), the \mas was not able to correctly identify
...
of 0.86, median \sscore of 0.71, and sd of 0.21). We also reengineer
...
Considering this sample of 30 \gps malware, the median \sscore is 0.95. In addition,
the repackaged version of the apps changes 6.9 methods (on median), and whenever the sample includes 2 new methods, it also delete 2 methods from the original app. Table~\ref{tab:simidroid-outputs} summarizes
the outputs of \texttt{SimiDroid} for this sample of \gps apps. The similarity assessment
of this sample of 30 \gps malware reveal a few modification patterns when comparing the original and the
repackaged versions of the apps. \fh{from this point forward we must review gappusin family action}First, no sample in this random selected \gps dataset

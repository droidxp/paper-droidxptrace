...
family. From \gps family, 1,170 samples ($87.5$\%), and from \fm{revmob} family 92 sample ($44.44$), the \mas was not able to correctly identify
...
%$\frac{27}{198} = 0.13$. 
Further, if we remove the \gps and \fm{revmob}

...
This result confirms that we were able to reproduce the findings of the original study using our infrastructure. 
...
We further analyze the sample of \gps malware in our dataset, given its

...
\begin{table}[ht!]
 ...
 \begin{tabular}{cccc}
   \toprule
   App pairs & Same API set (SAPI) & Trace Different (TD) & Improv. (\%) \\   \midrule
   800 &  607 & 176 & 22 \\
 \bottomrule
 \end{tabular}
 \end{small}
...
\begin{table}[ht]
 ...
 \begin{tabular}{cccccc}
   \toprule
   App pairs & (SAPI) & (DP) & (DA) & (DP or DA) \\   \midrule
   800 &  607 & 62 & 81 & 120 \\ 
...
The Venn-diagram of Figure XXX summarizes how Droidbot explorer, the trace analysis, and two kinds of suspicious manifest files can complement each other.

...
\centering{
  \begin{tabular}{llrrrrrr} \toprule
    ...
    Vanilla \mas   & \sds (102)    & 62   & 7   & 7   & 0.89      & 0.89   & 0.89  \\
    \mas + Traces  & \sds (102)   & 67   & 18  & 2   & 0.78      & 0.97   & 0.87  \\
    Vanilla \mas   & \cds (1203)    & 173  & 173 & 286 & 0.5       & 0.37   & 0.42  \\
    \mas + Traces  & \cds (1203)   & 214  & 326 & 245 & 0.39      & 0.46   & 0.42  \\ \bottomrule
  \end{tabular}
  }
  \label{tab:accuracy}
\end{table*}
...
\tb{4}{We found a negative and real association between
...
\tb{5}{Besides that, the \sscore assessment alone
...
Android malware can be classified into categories like riskware, trojan, adware, etc. Each category has several malware families associated with, that depend of your characteristics such as  steal network info (IP, DNS, WiFi), collect Phone info, collect user contacts, send/receive SMS, etc~\cite{DBLP:conf/iccns/RahaliLKTGM20}.
...
\tb{6}{The \mas fails to correctly

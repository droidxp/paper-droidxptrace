...
\centering{
  \begin{tabular}{llrrrrrr} \toprule
    ...
    \mas           & \sds    & 62   & 7  & 7   & 0.89      & 0.89   & 0.86  \\
    \mas + Traces  & \sds    & 67   & 18  & 2   & 0.78      & 0.97   & 0.83  \\
    \mas           & \cds    & 173  & 173 & 286 & 0.5      & 0.37   & 0.62  \\
    \mas + Traces  & \cds    & 214  & 326 & 245 & 0.39      & 0.46   & 0.62  \\ \bottomrule
  \end{tabular}
  }
  \label{tab:accuracy}
\end{table*}
...
to detect $7$ malware on the \sds (FN column, first row of Table~\ref{tab:accuracy}),
...
In general, the accuracy ($F_1$) of the \mas using trace analysis drops from 0.86 to 0.66.
...
\sds (see the third row of Table~\ref{tab:accuracy}), dropping from 0.86 to 0.62 (a reduction of 27.9\% in terms of $F_1$).
This indicates that, when considering a more representative dataset, the accuracy of the \mas using DroidBot drops significantly. 
...
\tb{3}{
  ...
  dropping the accuracy in 27.9\% smaller in comparison to

...
original versions of the apps. First, all samples in this random selected \gps dataset
do not modify the Android Manifest file---that is, they do not require new permissions, for instance.
Moreover, 19 out of the 20 samples in this dataset  introduce a new
method \texttt{void onReceive(android.content.Context,android.content.Intent)}
...
of the super class \texttt{AdReciver} super class, and then update the content of a \texttt{data.apk}
resource. 

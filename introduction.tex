...
might compromise the external validity of previous studuies. Second, their assessment do not investigate
...
Out of the total of \appsGps samples within this family, the \mas failed to correctly classify \appsGpsFN samples as malware (false negativs).

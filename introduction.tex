...
During our analysis we also observed another interesting insight that out of the 162 sensitive APIs explored, just xx (xx\%) was injected at most repackaged apps \rb{(All subjects in AndroZoo are based on repackaging)}. It indicates that we have a small set of sensitive APIs used generally by malicious developers, pointing out that researchers can concentrate their effort on this specific set of sensitive APIs to improve the security of Android apps. 

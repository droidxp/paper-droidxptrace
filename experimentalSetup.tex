...
anlysis for those pairs of apps for which the mining sandbox approach reports a false negative---that is,
...
Although both app version access the same set of sensitive resources, the

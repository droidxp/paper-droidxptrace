...
\review{Released in August 2018, the decision to use API 28 for the emulator is based on the fact that it is an intermediate version between the \repack and \amc versions. With this decision, we aim to cover the maximum number of samples in both datasets. Since Android apps are forward-compatible, older apps can run on newer versions of the Android Operating System.}

...
\begin{description}
\item[Small dataset] The small dataset comes from the work of Bao et al.~\cite{DBLP:conf/wcre/BaoLL18} and contains a set of 102 pairs of benign and malicious piggybacked apps. This is a curated
  ...
  builds upon 101 pairs of benign and malicious apps starting from the original 102 pairs of apps in the Bao et al. work~\cite{DBLP:conf/wcre/BaoLL18}. 

...
In this section, we discuss our methodology for identifying malware. We introduce the set Sensitive APIs diff procedure and then explain how our trace analysis and manifest file analysis work.

...
repackaged research, even though it only contains packages built up until 2018. For this reason, we decided to include samples from the \amc
...
us to follow an existing algorithm~\cite{~\cite{DBLP:journals/tse/LiBK21}} to identify the original versions of the repackaged apps in \amc,

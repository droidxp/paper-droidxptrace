...
Our \cds has an average similarity score of 59.72\%---with a much better distribution {\color{red}(401 of
app pairs have a similarity score of less than 0.25\%, 216 of app pairs
between 0.25\% and 0.50\%, 352 of the apps between 0.5\% and 0.75\%,
and 738 of the apps with more than 0.75\%). The \sds presents a much higher
